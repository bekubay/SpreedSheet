...
public class SpreadSheet {
	...
	private Cell[][] cells = new Cell[size][size]; // The fixed array of cells, each dimension from 1 to size, including
													// size
	...
	private String pad(String cellValue, int pads) // Put cell's contents in string and pad with blanks to reach the
													// desired length
	{
